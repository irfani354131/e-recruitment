                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Lihat Pelamar" type="button" class="btn btn-primary"><a style="color: #fff" href="<?php echo base_url('Psikolog/Data_nilai/nilai_pelamar/' . $key['id_lowongan']) ?>"><i class="fa fa-eye"></i></a></button>
                        <button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Download Nilai Ujian" type="button" class="btn btn-dark"><a style="color: #fff" href="<?php echo base_url('Administrator/Data_nilai/download_nilai/' . $key['id_lowongan']) ?>"><i class="fa fa-download"></i></a></button>
