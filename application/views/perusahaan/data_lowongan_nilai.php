                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Lihat Pelamar" type="button" class="btn btn-primary"><a style="color: #fff" href="<?php echo base_url('Perusahaan/Data_nilai/nilai_pelamar/' . $key['id_lowongan']) ?>"><i class="fa fa-eye"></i></a></button>
                      </div>
                    </td>
                  </tr>
                <?php $modal++;
