...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> KONTRAK PSIKOLOGIS</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">User</li>
      <li class="breadcrumb-item"><a href="#">Manage KONTRAK PSIKOLOGIS</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Manage KONTRAK PSIKOLOGIS</h3>
        <div class="tile-body">
          <div id="notifikasi">
          ...
          <div class="tile-body">
            ...
            ?>
              ...
              <form action="<?php echo base_url('Administrator/Data_ujian/updatekontrakpsikologis') ?>" method="post">
