...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i>BELBIN</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">User</li>
      <li class="breadcrumb-item"><a href="#">Manage BELBIN</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Manage BELBIN</h3>
        <div class="tile-body">
          <div id="notifikasi">
          ...
          <div class="tile-body">
            ...
            ?>
              ...
              <form action="<?php echo base_url('Administrator/Data_ujian/updatebelbin') ?>" method="post">
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Part 1 (Menit)</label>
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Part 2 (Menit)</label>
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Part 3 (Menit)</label>
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Part 4 (Menit)</label>
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Part 5 (Menit)</label>
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Part 6 (Menit)</label>
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Part 7 (Menit)</label>
