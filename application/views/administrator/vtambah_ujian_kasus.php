...
<main class="app-content">
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Ujian Kasus</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Ujian Kasus</h3>
        <div class="tile-body">
          <form action="<?php echo base_url('Administrator/Data_ujian/tambahdata_kasus') ?>" method="post">
            ...
            <a style="margin-top: 15px" href="<?php echo base_url('Administrator/Data_ujian/ujian_kasus') ?>" class="btn btn-secondary"> Cancel</a>
          </form>
        </div>
