...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> IST</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">User</li>
      <li class="breadcrumb-item"><a href="#">Manage IST</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Manage IST</h3>
        <div class="tile-body">
          <div id="notifikasi">
          ...
          <div class="tile-body">
            ...
            ?>
              ...
              <form action="<?php echo base_url('Administrator/Data_ujian/updateist') ?>" method="post">
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Latihan (Sub tes 1 - Sub tes 8) Menit</label>
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Latihan (Sub tes 9) Menit</label>
                  <input class="form-control" name="waktu_latihan9" value="<?php echo (strtotime($key['end_lat_sub9']) - strtotime($key['start_lat_sub9'])) / 60 ?>" type="text" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Sub Tes 5 (Menit)</label>
                  <input class="form-control" name="waktu_ujiansubtes5" value="<?php echo (strtotime($key['end_uji_sub5']) - strtotime($key['start_uji_sub5'])) / 60 ?>" type="text" required>
                  <?php echo date("H:i:s", strtotime($key['start_uji_sub5'])) ?> - <?php echo date("H:i:s", strtotime($key['end_uji_sub5'])) ?>
                </div>
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Sub Tes 6 (Menit)</label>
                  <input class="form-control" name="waktu_ujiansubtes6" value="<?php echo (strtotime($key['end_uji_sub6']) - strtotime($key['start_uji_sub6'])) / 60 ?>" type="text" required>
                  <?php echo date("H:i:s", strtotime($key['start_uji_sub6'])) ?> - <?php echo date("H:i:s", strtotime($key['end_uji_sub6'])) ?>
                </div>
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Sub Tes 7 (Menit)</label>
                  <input class="form-control" name="waktu_ujiansubtes7" value="<?php echo (strtotime($key['end_uji_sub7']) - strtotime($key['start_uji_sub7'])) / 60 ?>" type="text" required>
                  <?php echo date("H:i:s", strtotime($key['start_uji_sub7'])) ?> - <?php echo date("H:i:s", strtotime($key['end_uji_sub7'])) ?>
                </div>
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Sub Tes 8 (Menit)</label>
                  <input class="form-control" name="waktu_ujiansubtes8" value="<?php echo (strtotime($key['end_uji_sub8']) - strtotime($key['start_uji_sub8'])) / 60 ?>" type="text" required>
                  <?php echo date("H:i:s", strtotime($key['start_uji_sub8'])) ?> - <?php echo date("H:i:s", strtotime($key['end_uji_sub8'])) ?>
                </div>
                <div class="form-group">
                  <label class="control-label">Waktu Ujian Sub Tes 9 (Menit)</label>
                  <input class="form-control" name="waktu_ujiansubtes9" value="<?php echo (strtotime($key['end_uji_sub9']) - strtotime($key['start_uji_sub9'])) / 60 ?>" type="text" required>
                  <?php echo date("H:i:s", strtotime($key['start_uji_sub9'])) ?> - <?php echo date("H:i:s", strtotime($key['end_uji_sub9'])) ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label">Khusus Ujian Sub 5 & 6 : </label>
                  <input class="form-input" type="checkbox" value="aktif" name="khusus" <?php if ($key['khusus'] == "aktif") {
                                                                                          echo "checked";
                                                                                        } ?>>
                </div>
