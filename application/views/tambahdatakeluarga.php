			...
			<form action="<?php echo base_url('Pelamar/Pelamar/tambahdatakeluarga') ?>" method="post">
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-6 col-sm-12">
			      ...
			      <input required="required" type="text" class="form-control" name="pekerjaan_ayah" placeholder="Pekerjaan Ayah">
			    </div>
			    <div class="form-group col-md-6 col-sm-12">
			      <label for="inputNamaIbu">Nama Ibu</label>
			      <input required="required" type="text" class="form-control" name="nama_ibu" placeholder="Nama Ibu">
			    </div>
			    <div class="form-group col-md-6 col-sm-12">
			      <label for="inputPekerjaanIbu">Pekerjaan Ibu</label>
			      <input required="required" type="text" class="form-control" name="pekerjaan_ibu" placeholder="Pekerjaan Ibu">
			    </div>
			    <div class="form-group col-md-6 col-sm-12">
