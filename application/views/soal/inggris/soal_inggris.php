...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-th-list"></i> Bank Soal Bahasa Inggris</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">User</li>
      <li class="breadcrumb-item"><a href="#">Bank Soal Bahasa Inggris</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <a href="<?php echo base_url('Soal/Soal_inggris/tambahdata') ?>" class="btn btn-primary" style="margin-bottom: 2%;">Tambah Soal</a>
        <div id="notifikasi">
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                foreach ($inggris as $key) { ?>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo base_url('Soal/Soal_inggris/hapus_inggris/' . $key['id_soal']) ?>" title="Hapus Data"><button type="button" class="btn btn-danger">Hapus <i class="fa fa-trash"></i></button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="modal fade" id="myModalEdit<?php echo $modal ?>" role="dialog">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?php echo base_url('Soal/Soal_inggris/edit_inggris/' . $key['id_soal']) ?>" method="POST">
                            <div class="form-group">
                              <label class="control-label">No Soal</label>
                              <input type="hidden" name="id_soal" value="<?php echo $key['id_soal'] ?>">
                              <input class="form-control" name="nomor_soal" type="number" required="required" value="<?php echo $key['nomor_soal'] ?>">
                            </div>
                            <div class="form-group">
                              <label class="control-label">Cerita</label>
                              <textarea name="keterangan_soal" class="ckeditor" id="ckeditor" rows="3"><?php echo $key['keterangan_soal'] ?></textarea>
                            </div>
                            <div class="form-group">
                  ...
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $key['keterangan_soal'] ?></td>
