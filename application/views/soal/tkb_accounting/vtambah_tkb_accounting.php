...
<main class="app-content">
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Tambah Soal TKB Accounting Staff</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Tambah Soal TKB Accounting Staff</h3>
        <div id="notifikasi">
        ...
        <div class="tile-body">
          <form action="<?php echo base_url('Soal/Soal_tkb_accounting/tambah') ?>" method="post">
            <div class="form-group">
              <label class="control-label">No Soal</label>
              <?php $no_terakhir = $this->db->query("SELECT max(no_soal) as nomor_soal_terakhir FROM tb_soal_tkb_accountingstaff")->result();
              $id_terakhir = $this->db->query("SELECT max(id_soal) as id_soal_terakhir FROM tb_soal_tkb_accountingstaff")->result();
              ?>
            ...
            <a href="<?php echo base_url('Soal/Soal_tkb_accounting') ?>" class="btn btn-secondary"> Cancel</a>
          </form>
        </div>
