...
$database = 'tb_soal_tkb_bussinessdevelopmentstaff';
?>
<main class="app-content">
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Tambah Soal TKB Bussiness Development Staff</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Tambah Soal TKB Bussiness Development Staff</h3>
        <div id="notifikasi">
